...
- **Native Codex Skills** in Codex mode — the composer can attach local skills as protocol-level `skill` inputs, not prompt presets.
...
- **原生 Codex Skills**：Codex 模式下可在输入框挂载本地 Skill，发送的是协议级 `skill` input，不是 prompt preset。
